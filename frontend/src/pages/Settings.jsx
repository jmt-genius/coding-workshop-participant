    ...
    <div className="p-10 space-y-10 animate-in fade-in slide-in-from-right-4 duration-700">
      <header className="max-w-3xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary italic">Operational Preferences</span>
        </div>
          ...
          <div key={i} className="bg-surface-container rounded-[2rem] p-8 border border-outline-variant/10 hover:border-primary/30 transition-all group relative overflow-hidden cursor-pointer">
            <div className="flex items-start gap-6 relative z-10">
               ...
               <div>
                  ...
                  <p className="text-sm font-medium text-on-surface-variant leading-relaxed italic opacity-80">{section.desc}</p>
               </div>
            </div>
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between p-6 bg-surface-container rounded-3xl border border-outline-variant/5 group">
                 <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-on-surface-variant opacity-50 italic">{setting.status}</span>
                 </div>
      ...
      <footer className="pt-10 border-t border-outline-variant/10 flex justify-between items-center opacity-40 grayscale italic">
